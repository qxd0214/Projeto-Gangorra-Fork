...
export function Bluetooth() {
  ...
  /* async function scanDevices(){
    BLTManager.startDeviceScan(null, null, (error, scannedDevice) => {
      ...
      console.log('scan', scannedDevice);

      if (scannedDevice && scannedDevice.name == 'Demonstrador') {
   ...
   async function scanDevices() {
    PermissionsAndroid.request(
      ...
      BLTManager.startDeviceScan(null, null, (error, scannedDevice) => {
        ...
        console.log('scan', JSON.stringify(scannedDevice, null, 2));
  ...
  return (
    <View>
      ...
      <View style={styles.rowView}>
        <Text style={styles.titleText}>Demonstrador educacional</Text>
      </View>
